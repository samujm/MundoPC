...
public class MundoPC {
    ...
    public static void main(String[] args) {
        ...
        orden1.agregarComputadora(computadoraHP); //Agrega la computadora al arreglo
        orden1.agregarComputadora(computadoraGamer); //Agrega la segunda computadora al arreglo
